 ...
 * \file    heap_bt.c
 * \brief   This file contains functions used for buffer management
 */
...
/* Definig the max pools for the allocation */
#define OS_MAX_POOLS  3

/* Maxumum Heap Memory for the buffer management */
#define     OS_MAX_HEAP_MEMORY 		1200
UCHAR heap_memory[OS_MAX_HEAP_MEMORY];
...
/**
 * \fn      sdk_buffer_mgmt_init
 * \brief   Initialises the free buffer pools.
 * \param   None
 * \return  None
 * \see     heap_bt.c, sdk_pl.c
*/
