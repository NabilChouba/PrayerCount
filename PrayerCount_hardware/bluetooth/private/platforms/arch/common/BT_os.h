...
#define POOL_SMALL                      0
#define POOL_MEDIUM_1                   1
#define POOL_MEDIUM_2                   2
#define POOL_LARGE                      3

/* Max number of pools used */
#define POOL_MAX                        4

#define BT_MEM_SMALL_SIZE                               32
#define BT_NUM_SMALL_SIZE_BLK                           2

#define BT_MEM_MEDIUM_1_SIZE                            128
#define BT_NUM_MEDIUM_1_SIZE_BLK                        2

#define BT_MEM_MEDIUM_2_SIZE                            260
#define BT_NUM_MEDIUM_2_SIZE_BLK                        3

#define BT_MEM_LARGE_SIZE                               1024
#define BT_NUM_LARGE_SIZE_BLK                           4
